...
// Задача 10a:Напишіть рекурсивну функцію, яка обчислює суму чисел від 1 до заданого числа.

function getFee(isMember) {
  return "The fee is " + (isMember ? "$2.00" : "$10.00");
}
console.log("Завдання 10a ====================================");
...
function memoizedArea(a = null, oldResult = null) {
